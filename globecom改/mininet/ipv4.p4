...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.arp.isValid()) {
            ...
            if (hdr.arp.target_ip == 0x0a000101) {
                //ask who is 10.0.1.1
                hdr.ethernet.dst_mac = hdr.ethernet.src_mac;
                hdr.ethernet.src_mac = 0xa0369f08d128;
                hdr.arp.OPER = 2;
                hdr.arp.target_ha = hdr.arp.sender_ha;
                hdr.arp.target_ip = hdr.arp.sender_ip;
                hdr.arp.sender_ip = 0x0a000101;
                hdr.arp.sender_ha = 0xa0369f08d128;
                standard_metadata.egress_spec = standard_metadata.ingress_port;
            }
            else if (hdr.arp.target_ip == 0x0a000201) {
                //ask who is 10.0.2.1
                hdr.ethernet.dst_mac = hdr.ethernet.src_mac;
                hdr.ethernet.src_mac = 0xd0369fed5c63;
                hdr.arp.OPER = 2;
                hdr.arp.target_ha = hdr.arp.sender_ha;
                hdr.arp.target_ip = hdr.arp.sender_ip;
                hdr.arp.sender_ip = 0x0a000201;
                hdr.arp.sender_ha = 0xd0369fed5c63;
                standard_metadata.egress_spec = standard_metadata.ingress_port;
            }            
            else if (hdr.arp.target_ip == 0x0a000301) {
                //ask who is 10.0.3.1
                hdr.ethernet.dst_mac = hdr.ethernet.src_mac;
                hdr.ethernet.src_mac = 0xa0369f08c7b7;
                hdr.arp.OPER = 2;
                hdr.arp.target_ha = hdr.arp.sender_ha;
                hdr.arp.target_ip = hdr.arp.sender_ip;
                hdr.arp.sender_ip = 0x0a000301;
                hdr.arp.sender_ha = 0xa0369f08c7b7;
                standard_metadata.egress_spec = standard_metadata.ingress_port;
            }
        }
